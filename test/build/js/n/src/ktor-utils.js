(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'ktor-utils'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'ktor-utils'.");
    }
    if (typeof this['kotlinx-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-utils'. Its dependency 'kotlinx-io' was not found. Please, check whether 'kotlinx-io' is loaded prior to 'ktor-utils'.");
    }
    if (typeof this['kotlinx-coroutines-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-utils'. Its dependency 'kotlinx-coroutines-io' was not found. Please, check whether 'kotlinx-coroutines-io' is loaded prior to 'ktor-utils'.");
    }
    if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'ktor-utils'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'ktor-utils'.");
    }
    root['ktor-utils'] = factory(typeof this['ktor-utils'] === 'undefined' ? {} : this['ktor-utils'], kotlin, this['kotlinx-io'], this['kotlinx-coroutines-io'], this['kotlinx-coroutines-core']);
  }
