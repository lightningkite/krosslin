(function (root, factory) {
  ...
  function copyTo_0($receiver, dst, limit, continuation) {
    ...
    var tmp$, tmp$_0;
    return copyToSequentialImpl(Kotlin.isType(tmp$ = $receiver, ByteChannelSequentialBase) ? tmp$ : throwCCE(), Kotlin.isType(tmp$_0 = dst, ByteChannelSequentialBase) ? tmp$_0 : throwCCE(), Long$Companion$MAX_VALUE, continuation);
  }
