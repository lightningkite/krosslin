...
class ControlsVG<VIEW>() : ViewGenerator<ViewFactory<VIEW>, VIEW> {
    ...
    override fun generate(dependency: ViewFactory<VIEW>): VIEW = with(dependency) {
        scrollVertical(vertical {
            ...
            -entryContext(
                    label = "numberField",
                    field = numberField(value = TransformMutableObservableProperty(
                            observable = StandardObservableProperty(22.45),
            ...
            val observable = StandardObservableProperty(42L)
            -numberField(
